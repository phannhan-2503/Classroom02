...
public class updatebaigiangFragment extends Fragment {
    ...
    private View mView;
    private Quanlybantingiaovien mainActivityBangTin;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mainActivityBangTin = (Quanlybantingiaovien) getActivity();
    ...
    private void updateDataOnFirebase(String newContent, String key) {
        ...
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference().child("BangTin").child(value).child(key); // Thay "1" bằng key thực tế của mục dữ liệu
